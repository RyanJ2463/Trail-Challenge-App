...
/**
 * Shared by the "Profile" tab (viewing yourself) and the pushed
 * /profile/[id] route (viewing someone else, e.g. from Friends). Only the
 * latter needs a native header with the viewed person's name, since the tab
 * already shows the avatar/name inline -- hence `setNativeTitle`.
 */
export function ProfileView({ userId, setNativeTitle = false }: { userId: string; setNativeTitle?: boolean }) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      {setNativeTitle && <Stack.Screen options={{ title: profile.displayName }} />}
